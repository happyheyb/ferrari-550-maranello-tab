var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/ferrari-550-maranello-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/ferrari-550-maranello-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/ferrari-550-maranello-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/ferrari-550-maranello-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Ferrari 550 Maranello?",
				description: "Get awesome Ferrari 550 Maranello HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
